      ...
      {report.executiveDossier && (
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-black uppercase text-white tracking-widest">Executive Biomechanical Dossier</h3>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-red-950/20 border border-red-500/20 rounded-2xl p-5">
              <span className="text-[10px] font-black text-red-400 uppercase tracking-widest mb-1 block">Primary Fault Detected</span>
              ...
              <div className="flex items-center gap-2 bg-red-950/40 border border-red-500/20 p-2 rounded-lg text-[10px] text-red-300">
            ...
            <div className="bg-emerald-950/20 border border-emerald-500/20 rounded-2xl p-5">
              <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest mb-1 block">Gold Standard Alignment</span>
              ...
              <div className="flex items-center gap-2 bg-emerald-950/40 border border-emerald-500/20 p-2 rounded-lg text-[10px] text-emerald-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="text-sm font-black uppercase text-white tracking-widest">Key Strengths</h3>
          </div>
          <div className="flex flex-col gap-3">
            {report.strengthsDetailed ? (
              report.strengthsDetailed.map((strength: StrengthItem, i: number) => (
                <div key={i} className="bg-zinc-950/50 border border-zinc-800 p-4 rounded-2xl">
              ...
              report.keyStrengths.map((strength: any, i: number) => (
                <div key={i} className="flex items-start gap-3 bg-zinc-950/50 border border-zinc-800 p-3 rounded-xl">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="text-sm font-black uppercase text-white tracking-widest">Growth Opportunities</h3>
          </div>
          <div className="flex flex-col gap-3">
              ...
              <div key={i} className="bg-zinc-950/50 border border-zinc-800 p-4 rounded-2xl">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 p-3 rounded-xl">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-[10px] font-black text-amber-400 uppercase">Corrective Drill</span>
                    <span className="text-[9px] font-bold text-zinc-500">{area.drillReps}</span>
                  </div>
                  <h5 className="text-[11px] font-bold text-zinc-200">{area.drillName}</h5>
